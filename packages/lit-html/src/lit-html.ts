...
// Types sourced from local types.d.ts instead of trusted-types npm package
import type {TrustedHTML, TrustedTypesWindow} from './types.js';
...
const getTemplateHtml = (
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  return [trustFromTemplateString(strings, htmlResult as any), attrNames];
};
